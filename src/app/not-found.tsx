...
export default function NotFound() {
  return (
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#050403', textAlign: 'center', padding: '40px' }}>
      <span style={{ fontFamily: 'var(--font-sans)', fontSize: '9px', fontWeight: 700, letterSpacing: '0.22em', textTransform: 'uppercase', color: '#D4B28C', marginBottom: '24px', display: 'block' }}>404</span>
      ...
      <Link href="/" style={{ display: 'inline-flex', alignItems: 'center', height: '52px', padding: '0 36px', background: '#D4B28C', color: '#050403', fontFamily: 'var(--font-sans)', fontSize: '11px', fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', textDecoration: 'none' }}>
        Back to Home
      </Link>
    </main>
  );
