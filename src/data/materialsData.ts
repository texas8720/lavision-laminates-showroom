...
export const MATERIALS: MaterialSpec[] = [
  ...
  },
  {
    ...
    category: 'Louvers',
    categorySlug: 'louvers',
    texture: 'repeating-linear-gradient(90deg, #F3C623 0px, #F3C623 15px, #4A3215 16px, #4A3215 30px)',
  ...
  // 7. Decorative Panels
  {
    ...
    texture: 'repeating-linear-gradient(90deg, #3A3225 0px, #3A3225 20px, #F3C623 21px, #F3C623 24px)',
