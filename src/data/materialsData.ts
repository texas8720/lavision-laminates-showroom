...
export const MATERIALS: MaterialSpec[] = [
  ...
  },
  {
    ...
    category: 'Louvers',
    categorySlug: 'louvers',
    texture: 'repeating-linear-gradient(90deg, #D4B28C 0px, #D4B28C 15px, #4A3215 16px, #4A3215 30px)',
  ...
  // 7. Decorative Panels
  {
    ...
    texture: 'repeating-linear-gradient(90deg, #3A3225 0px, #3A3225 20px, #D4B28C 21px, #D4B28C 24px)',
